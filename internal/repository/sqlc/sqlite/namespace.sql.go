...
INSERT INTO namespaces (name) VALUES (?) RETURNING id, name, created_at, updated_at, deleted_at
`
...
SELECT id, name, created_at, updated_at, deleted_at FROM namespaces WHERE id = ? AND deleted_at IS NULL LIMIT 1
`
